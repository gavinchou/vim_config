...
syn match markdownListMarker "\%(\t*\| \{2\}\| \{4\}\| \{6\}\| \{8\}\| \{10\}\| \{12\}\)[-*+]\%(\s\+\S\)\@=" contained

" syn region markdownListBlock start="\%(\t\[-*+]\)\(\s\+\S\)\@=" end="\%(\t\)[-*+]\%(\s\+\S\)\@=" contained contains=markdownListMarker, markdownOrderedListMarker, markdownCodeBlock

" syn match markdownOrderedListMarker "\%(\t\| \{0,4}\)\<\d\+\.\%(\s\+\S\)\@=" contained
syn match markdownOrderedListMarker "\%(\t*\| \{2\}\| \{4\}\| \{6\}\| \{8\}\| \{10\}\| \{12\}\)\<\d\+\.\%(\s\+\S\)\@=" contained

syn match markdownRule "\* *\* *\*[ *]*$" contained
syn match markdownRule "- *- *-[ -]*$" contained

syn match markdownLineBreak " \{2,\}$"
syn match markdownEmptyLine "^\s*$"
...
hi def link markdownListMarker            Red
...
hi def link markdownLinkText              HttpLink
